...
const Hero = () => {
  return (
    <section
      id="hero"
      className="bg-gradient-to-br from-indigo-600 to-purple-800 text-white flex justify-center items-center h-screen pt-20"
    >
      <div className="w-full max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <a
            href="/resume.pdf"
            download
            className="px-6 py-3 bg-transparent border border-white text-white font-semibold rounded-lg hover:bg-white hover:text-indigo-600 transition"
          >
            Download Resume
          </a>
        </div>
